...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MP3Coin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mp3cointools.com", "dnsseed.mp3cointools.com"},
    {"mp3coinpool.org", "dnsseed.mp3coinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"mp3cointools.com", "testnet-seed.mp3cointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MP3Coin is probably already running."), addrBind.ToString().c_str());
        else
